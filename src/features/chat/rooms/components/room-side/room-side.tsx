    ...
    return (
      <RoomActions>
        <div
          ref={ref}
          {...props}
          className="md:container-height full-screen-height absolute left-0 top-0 z-50 w-screen overflow-y-auto border-l bg-background p-3 pb-0 md:relative md:z-auto md:w-full"
        >
          {tabsMap[currentSide]}
        </div>
      </RoomActions>
