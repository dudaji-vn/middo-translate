...
export default function useGenerateSystemMessageContent(message : Message, isMe ?: boolean) {
    ...
    }, [message.targetUsers, message.action, message.sender.name, message.content, t, isMe])
