...
export const LanguageSelect = ({
  ...
  return (
    <div className="flex h-[42px] w-full flex-1 items-center gap-2">
      <div className="flex h-full w-full gap-2 overflow-hidden rounded-2xl font-semibold lg:w-fit lg:bg-neutral-50 lg:p-1">
...
const LanguageItem = ({
  ...
  return (
    <button
      onClick={onClick}
      className={cn(
        'relative flex h-full w-full items-center justify-between gap-2 rounded-xl px-2 lg:w-fit lg:justify-center lg:px-3',
    ...
    >
      ...
      <div className="z-10 flex flex-1 items-center gap-2 overflow-hidden">
        {code && code !== 'auto' ? (
          <CircleFlag
      ...
      <ChevronDownIcon className="z-10 text-neutral-600 lg:hidden" />
    </button>
  );
};
