...
import { HeaderNotify } from './header-notify';
const HeaderProfile = ({
  className,
  ...props
    ...
    <div className="relative h-full md:w-[60px]">
      ...
      >
        {isAuthentication && user ? (
          <>
            <DropdownMenu open={isOpenDropdown} onOpenChange={setOpenDropdown}>
              ...
              <DropdownMenuContent
                ...
                className="rounded-2xl dark:border-neutral-800 dark:bg-neutral-900"
              >
          ...
          <DropdownMenu open={isOpenDropdown} onOpenChange={setOpenDropdown}>
            <DropdownMenuTrigger>
              <div className="relative flex h-9 items-center gap-2 rounded-xl bg-neutral-50 px-3 py-[6px] active:!bg-neutral-200 active:!text-shading dark:bg-transparent dark:active:!bg-neutral-700 md:py-1 md:hover:bg-neutral-100 dark:md:hover:bg-neutral-800">
