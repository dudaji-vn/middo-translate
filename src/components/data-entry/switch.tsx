...
>(({ className, ...props }, ref) => (
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        'border-1 pointer-events-none block h-4 w-4 rounded-full border-input bg-background  shadow-lg ring-0 transition-transform data-[state=checked]:translate-x-[18px] data-[state=unchecked]:translate-x-[2px] data-[state=checked]:border-primary',
      )}
    />
  </SwitchPrimitives.Root>
));
