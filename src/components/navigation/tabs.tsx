...
const tabsTriggerVariants = cva('', {
  variants: {
    variant: {
      ...
      unset: '',
      button:
        'border-none  hover:bg-neutral-100 hover:text-neutral-700 relative inline-flex w-full items-center justify-center whitespace-nowrap rounded-none px-3 py-2  text-base md:text-sm font-medium ring-offset-background transition-all focus-visible:outline-none text-neutral-400 focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:text-neutral-800  bg-transparent  data-[state=active]:bg-white  *:data-[state=active]:block',
    },
  },
});
