...
>(
  (
    ...
    return (
      <>
        <div className={cn('flex-1 py-5 md:relative', className)}>
          {!image && (
            <label
              htmlFor={id}
              className="flex h-full border-spacing-3 cursor-pointer flex-col items-center justify-center rounded-lg border border-dashed border-primary p-4 py-32 transition-all hover:bg-slate-50 dark:hover:bg-neutral-900"
            >
              ...
              <div className="mx-auto mt-5 flex max-w-[288px] items-center justify-center gap-2">
                ...
                <Range
                  ...
                  renderTrack={({ props, children }) => (
                    <div
                      {...props}
                      className="h-1 w-full rounded bg-gray-200 dark:bg-neutral-900"
                    >
                      {children}
                    </div>
                  )}
