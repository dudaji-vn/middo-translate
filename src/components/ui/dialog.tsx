...
>(({ className, children, ...props }, ref) => (
  ...
  >
    {children}
    <DialogPrimitive.Close className="absolute right-1 top-1 rounded-sm opacity-70  transition-opacity hover:opacity-100 focus:outline-none  disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground">
