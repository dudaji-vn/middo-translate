...
const AlertDialogHeader = ({
  ...
  <div
    className={cn('flex flex-col text-start sm:text-left', className)}
    {...props}
  />
);
...
const AlertDialogFooter = ({
  ...
  <div
    className={cn('!mt-6 flex justify-end space-x-2 sm:flex-row', className)}
    {...props}
  />
);
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Title
    ref={ref}
    className={cn('flex h-12 items-center text-2xl font-medium', className)}
    {...props}
  />
));
