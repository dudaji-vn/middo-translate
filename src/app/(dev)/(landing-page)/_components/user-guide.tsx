...
export default function UserGuide() {
  ...
  const onChangeAccordion = (value: string, level: 0 | 1 | 2) => {
    ...
    const param: 'guide' | 'guide_1' | 'guide_2' =
      level === 0 ? 'guide' : `guide_${level}`;
    if (!value) {
      currentGuide[param] = '';
    } else {
  ...
  const guides = [
          ...
          data={[
            {
              ...
              header: (
                <p>
                  <span className="font-semibold">Source</span> is the left-side
                  text box in Translation page where you can input your text
                  which need to be translated at there
                </p>
              ),
              ...
              subItems: [
                ...
                },
                {
                  ...
                  content:
                    'The English translated text from your inputed source. Middo use it to compare with the E.S.L translated from target in order to give you the high accuracy translation. It will be display in 2 different colors, each means:',
                  subContent: (
                    <ul className="ml-5 mt-5 flex list-disc flex-col gap-3">
                      <li>
                        <span className="font-semibold text-error-400-main">
                          Red:
                        </span>{' '}
                        E.S.L source and E.S.L target are not matched
                      </li>
                      <li>
                ...
                },
                {
                  ...
                  content:
                    'If the E.S.L translated not contains the correct means from your original text, you can edit to correct it.',
                },
                {
                  id: 'text-to-speech',
            ...
            },
            {
              ...
              header: (
                <p>
                  <span className="font-semibold">Target</span> is the
                  right-side text box in Translation page where your translated
                  text was placed
                </p>
              ),
              ...
              subItems: [
                {
                  ...
                  content:
                    'Click this button to open the list of supported language',
                },
                {
                  id: 'target-language',
                ...
                },
                {
                  ...
                  content:
                    'The English translated text from your target text. Middo use it to compare with the E.S.L translated from source in order to give you the high accuracy translation. It will be display in 2 different colors, each means:',
                  subContent: (
                    <ul className="ml-5 mt-5 flex list-disc flex-col gap-3">
                      <li>
                        <span className="font-semibold text-error-400-main">
                ...
                },
                {
                  ...
                  content:
                    'IWhen E.S.Ls are not matched, this button will be shown up. Click it if you think the difference between the source and target E.S.L translated text is acceptable and usable. Until the green E.S.L show up, you can use other advance features.',
                },
                {
                  id: 'text-to-speech',
                  title: 'Text-to-Speech',
              ...
              subItems: [
                {
                  ...
                  title: 'History',
                  content:
                    'Click this button to open the history of your translation',
                },
                {
                  id: 'phrases',
                  title: 'Phrases',
                  content:
                    'Phrases contain more than 100 sample sentences for you to use in under any specific circumstances',
                },
                {
                  id: 'copy-all-text',
                  title: 'Copy all text',
                  content:
                    'Click this button to copy: Source text & Target text & E.S.L translated from source text. Only works when meets:',
                  subContent: (
                    <ul className="ml-5 mt-5 flex list-disc flex-col gap-3">
                      <li>Source & Target language are not in English</li>
                      <li>E.S.L source and E.S.L target is green</li>
                    </ul>
                  ),
                },
                {
                  ...
                  subContent: (
                    <span className="text-sm font-light italic">
                      *Note: This button is not working on Auto Detect Language
                      mode
                    </span>
                  ),
                },
                {
                  ...
                  content:
                    'Click this button to quickly take the screenshot of the translation you made to share with anyone. Only works when meets:',
                  subContent: (
                    <ul className="ml-5 mt-5 flex list-disc flex-col gap-3">
                      <li>Source & Target language are not in English</li>
                      <li>E.S.L source and E.S.L target is green</li>
          ...
          data={[
            {
              ...
              subItems: [
                ...
                },
                {
                  ...
                  title: 'Search bar',
                  content:
                    'Enter username, person’s name or group’s name to search',
                },
                {
                  ...
                  subContent: (
                    <ul className="ml-5 mt-5 flex list-disc flex-col gap-3">
                      <li>Group: contains only group type conversations</li>
                      <li>Archive: contains only archived conversations</li>
                      <li>
                ...
                },
                {
                  ...
                  subContent: (
                    <ul className="ml-5 mt-5 flex list-disc flex-col gap-3">
                      <li>Name: the Person’s name or Group’s name</li>
                      <li>
                ...
                },
                {
                  ...
                  content:
                    'This icon will be shown whenever the conversation’s notification is turned off by you',
                },
                {
            ...
            },
            {
              ...
              subItems: [
                  ...
                  subContent: (
                    <ul className="ml-5 mt-5 flex list-disc flex-col gap-3">
                      <li>
                        ...
                        This user or every users in this group is not using
                        Middo currently
                      </li>
                      <li>
                        <span className="font-semibold text-success-700">
                        ...
                        : This user or every users in this group is using Middo
                        currently
                      </li>
                    </ul>
                  ),
                ...
                },
                {
                  ...
                  title: 'Timestamp',
                  content:
                    'Every 10 minutes, a timestamp will be shown to let you know when was this conversation’s section was started',
                },
                {
                  id: 'message-item',
                  title: 'Message item',
            ...
            },
            {
              ...
              subItems: [
                ...
                },
                {
                  ...
                  content:
                    'Message content will only be translated for receiver',
                },
                {
                ...
                },
                {
                  ...
                  content:
                    'Whenever you click a message item, message’s informations will be shown. It will contains:',
                  subContent: (
                    <ul className="ml-5 mt-5 flex list-disc flex-col gap-3">
                      <li>Which language the message was translated from</li>
                      <li>Timestamp of this message</li>
                    </ul>
                  ),
                },
                {
                ...
                },
                {
                  ...
                  title: 'Reply status',
                  content:
                    'This status only appears whenever a message had “Reply in Discussion”',
                },
                {
                  id: 'emoji-status',
                  title: 'Emoji status',
                  content:
                    'This status only appears whenever a message had emoji reaction by someone',
                },
                {
                  id: 'seen-status',
                  title: 'Seen status',
                  content:
                    'This status only appears whenever a message is seen by other',
                },
              ],
            },
            {
              ...
              subItems: [
                ...
                },
                {
                  ...
                  title: 'Send',
                  content:
                    'Only appears whenever input message box has content',
                },
              ],
            },
            {
              ...
              subItems: [
                ...
                },
                {
                  ...
                  content:
                    'You would have notifications in Discussion, whenever you relative to this Discussion:',
                  subContent: (
                    <ul className="ml-5 mt-5 flex list-disc flex-col gap-3">
                      <li>
                        If you&apos;re mentioned in any message of Discussion
                      </li>
                      <li>If you replies in a Discussion</li>
                    </ul>
                  ),
                },
              ],
            },
            {
              ...
              subItems: [
                ...
                },
                {
                  ...
                  content:
                    'When a Middo Call is started, only invited-to-join member receive the calling notification screen.',
                },
                {
                ...
                },
                {
                  ...
                  subContent: (
                    <ul className="ml-5 mt-5 flex list-disc flex-col gap-3">
                      <li>Share screen</li>
                      <li>Turn on/off camera</li>
                      <li>Turn on/off microphone</li>
                      <li>Leave call</li>
                    </ul>
                  ),
                },
            ...
            },
            {
              ...
              subItems: [
                ...
                },
                {
                  ...
                  content:
                    'Whenever you start sharing your screen, a tool box will be displayed at top to help you represent your screen:',
                  subContent: (
                    <ul className="ml-5 mt-5 flex list-disc flex-col gap-3">
                      <li>
                        Doodle: allows you to draw on your screen. The drew line
                        will auto disappear after a few seconds
                      </li>
                      <li>Turn on/off microphone</li>
                      <li>Turn on/off camera</li>
                      <li>Stop sharing screen</li>
                    </ul>
                  ),
                },
                {
                  ...
                  content:
                    'In maximize mode, there are 4 advance tools to use:',
                  subContent: (
                    <ul className="ml-5 mt-5 flex list-disc flex-col gap-3">
                      <li>Gallery view</li>
                      <li>
                        Screen capture (Only work when sharing screen happens):
                        Quickly take a screenshot of the shared screen, all
                        member join this call could draw on it
                      </li>
                      <li>
                        Caption: Speech-to-Text all member voice, and auto
                        translate to the receiver’s native language
                      </li>
                      <li>Video and audio settings</li>
                    </ul>
                  ),
                },
              ],
    ...
    },
    {
      ...
      title: 'How to embed Conversation to your website? (Extension)',
      content: (
        <MultiStepAccordion
          onPreviewImage={onPreviewImage}
          steps={[
              ...
              items: [
                {
                  content: (
                    <p>
                      1. Go to 
                      <a href="https://middo.app/spaces" target="_blank">
                        https://middo.app/spaces
                      </a>
                    </p>
                  ),
                ...
                },
                {
                  content: (
                    <p>
                      2. Click “Create New Space”: Then give your space name,
                      avatar, and add members
                    </p>
                  ),
              ...
              items: [
                {
                  content: (
                    <p>
                      1. Go to “Settings” page. Move to “Conversation
                      Extension&quot; tab
                    </p>
                  ),
                ...
                {
                  content: (
                    <p>2. Click “Create Extension” and set up your extension</p>
                  ),
                ...
                },
                {
                  content: (
                    <p>
                      3.1. Set up your domain (the list of public sites that you
                      allow your Conversation Extension to appear on)
                    </p>
                  ),
                ...
                },
                {
                  content: (
                    <div>
                      <p>
                        3.2. Set up your starting message. There&apos;re 3
                        options:
                      </p>
                      <ul className="ml-5 mt-5 flex list-disc flex-col gap-3">
                        <li>
                          <span className="font-semibold">Default:</span> a
                          default message to greet and guide users
                        </li>
                        <li>
                          <span className="font-semibold">Custom:</span> write
                        ...
                        <li>
                          ...
                          Choose available script or create your new script
                        </li>
                      </ul>
                    </div>
                  ),
                ...
                },
                {
                  content: (
                    <p>
                      3.3. Custom your Extension. You can choose: Theme,
                      Conversation icon, and other options
                    </p>
                  ),
                ...
                },
                {
                  content: (
                    <p>
                      4. Copy embed code: After created Conversation Extension,
                      you can copy your embed code on your setting page
                    </p>
                  ),
            ...
            },
            {
              ...
              content: (
                <>
                  <p>
                    Adding the embed code to your website may vary depending on
                    the type of website platform you are using. Here are some
                    basic instructions for some popular platforms:
                  </p>
                  <ContentMultiStep
                    guide={guide}
                    steps={[
                      {
                        ...
                        title:
                          'Embedding into the HTML source code of your website:',
                        content: (
                          <div>
                            <p>
                              If you have access to the HTML source code of your
                              website, you can directly paste the embed code
                              there. For example:
                            </p>
                            <div className="mt-2 w-full">
                              <Image
                                onClick={() =>
                                  onPreviewImage('/landing-page/3.i.png')
                                }
                                src="/landing-page/3.i.png"
                                alt=""
                                width={1000}
                                height={500}
                      ...
                      },
                      {
                        ...
                        content: (
                          <div>
                            <p>
                              If you&apos;re using WordPress, you can add the
                              embed code:
                            </p>
                            <p>
                              a. Access your WordPress (
                              <a
                                href="https://wordpress.com/login"
                                target="_blank"
                              >
                            ...
                            <ul className="ml-5 mt-5 flex list-disc flex-col gap-3">
                              <li>
                                ...
                                <div className="mt-2 w-full">
                                  <Image
                                    onClick={() =>
                                      onPreviewImage('/landing-page/3.j.png')
                                    }
                                    src="/landing-page/3.j.png"
                                    alt=""
                                    width={1000}
                                    height={500}
                                    className="mx-auto block w-full"
                              ...
                              <li>
                                <span>
                                  Click on the page you want your chat, or click
                                  on &quot;Add new page”
                                </span>
                                <div className="mt-2 w-full">
                                  <Image
                                    onClick={() =>
                                      onPreviewImage('/landing-page/3.k.png')
                                    }
                                    src="/landing-page/3.k.png"
                                    alt=""
                                    width={1000}
                                    height={500}
                                    className="mx-auto block w-full"
                            ...
                            <ul className="ml-5 mt-5 flex list-disc flex-col gap-3">
                              <li>
                                ...
                                <div className="mt-2 w-full">
                                  <Image
                                    onClick={() =>
                                      onPreviewImage('/landing-page/3.l.png')
                                    }
                                    src="/landing-page/3.l.png"
                                    alt=""
                                    width={1000}
                                    height={500}
                                    className="mx-auto block w-full"
                              ...
                              <li>
                                <span>
                                  Search for &quot;Custom HTML&quot; and click
                                  it
                                </span>
                                <div className="mt-2 w-full">
                                  <Image
                                    onClick={() =>
                                      onPreviewImage('/landing-page/3.m.png')
                                    }
                                    src="/landing-page/3.m.png"
                                    alt=""
                                    width={1000}
                                    height={500}
                                    className="mx-auto block w-full"
                              ...
                              <li>
                                ...
                                <div className="mt-2 w-full">
                                  <Image
                                    onClick={() =>
                                      onPreviewImage('/landing-page/3.n.png')
                                    }
                                    src="/landing-page/3.n.png"
                                    alt=""
                                    width={1000}
                                    height={500}
                                    className="mx-auto block w-full"
                      ...
                      },
                      {
                        ...
                        content: (
                          <p>
                            You can contact your website administrator or
                            developer if you cannot add the embed code. Please
                            provide them with the embed code and instructions to
    ...
    },
    {
      ...
      title: 'How to manage your Script Conversation? (Extension)',
      content: (
        <MultiStepAccordion
          onPreviewImage={onPreviewImage}
          guide={guide}
          paragraph={
            <p>
              Script Conversation guides for representatives to get the ball
              rolling in conversations. But Script Conversation can also double
              up as proactive messages in high-performing pages. You can use
              these messages to start conversations with website visitors even
          ...
          steps={[
            {
              ...
              items: [
                {
                  content: (
                    <p>This page only available for Admin and Space’s owner</p>
                  ),
                ...
                },
                {
                  content: (
                    <div>
                      ...
                      <p className="mt-1">
                        Preview your script by clicking the “Preview” button:
                        it’ll open a new fake embed chat for you to test it out.
                      </p>
                    </div>
                  ),
...
const WhatIsMiddo = () => {
  return (
    <>
      <span className="font-semibold text-primary-500-main">Middo</span> is your
      ultimate companion for seamless communication across languages. With{' '}
      <span className="font-semibold text-primary-500-main">Middo</span> , you
      can translate web pages effortlessly, and engage in real-time
      conversations with anyone, anywhere. Break down language barriers and
      connect with people from all around the globe like never before. <br></br>
      <p className="py-3">Key Features:</p>
      <ul className="flex list-disc flex-col gap-3 pl-3">
        <li>
          <span className="font-semibold">Translation:</span> Middo&apos;s
          powerful translation engine ensures that you can access and understand
          content in any language instantly.
        </li>
        <li>
          <span className="font-semibold">Real-time Conversation:</span> Chat
          with friends, family, or colleagues in real-time, regardless of their
          language. Middo automatically translates messages, allowing for smooth
          and natural conversations.
        </li>
        <li>
          <span className="font-semibold">Auto-Translate Messages: </span> Say
          goodbye to language confusion. Middo automatically detects the
          language of incoming messages and translates them into your preferred
          language, making communication effortless.
        </li>
        <li>
          <span className="font-semibold">Multi-Language Support:</span> Speak
          and be understood in over 100 languages. Middo covers a wide range of
          languages, ensuring that you can communicate effectively with people
          from diverse backgrounds.
        </li>
        <li>
          <span className="font-semibold">User-friendly Interface: </span>{' '}
          Middo&apos;s intuitive interface makes it easy for anyone to navigate
          and use the app. Whether you&apos;re a seasoned traveler or a casual
          user, Middo provides a seamless experience
        </li>
      </ul>
    </>
  );
...
const WhatIsESLTranslation = () => {
  return (
    <p>
      <span className="font-semibold text-primary-500-main">E.S.L</span> stands
      for <span className="font-semibold"> English as a Second Language </span>{' '}
      . This is the term used to refer to learning English for people who have
...
const WhyCanNotReplyConversation = ({
  ...
  return (
    <div>
      ...
      <ul className="ml-5 mt-5 flex list-disc flex-col gap-3">
        <li>
          <span className="font-semibold">In Conversation page:</span> You’re
          blocked by a user
        </li>
        <li>
          <span className="font-semibold">In Extension page:</span> The user you
          want to send message has left the conversation, or this conversation
          is timed out
        </li>
      </ul>
      <div className="mt-2 w-full">
        <Image
          onClick={() => onPreviewImage('/landing-page/5.a.png')}
          src="/landing-page/5.a.png"
          alt=""
          width={1000}
          height={500}
          className="mx-auto block w-full"
        ...
        return (
          <AccordionItem value={item.id} key={item.id} id={'guide_1' + item.id}>
            ...
            <AccordionContent className="px-2 py-5 text-base">
              {item?.header}
              <div className="mt-5 flex flex-col justify-start gap-10 md:flex-row">
...
const MultiStepAccordion = ({
  ...
  return (
    <div>
      <div className="mb-5">{paragraph}</div>
      <Accordion
        type="single"
        collapsible
        className="flex flex-col gap-3"
        ...
        {steps.map((step) => {
          return (
            <AccordionItem value={step.id} key={step.id}>
              ...
              <AccordionContent className="flex flex-col gap-4 px-2 py-2 text-base">
                {step?.items?.map((item) => {
                  return (
                    <div key={item.image}>
                      {item.content}
...
const ContentMultiStep = ({
  steps,
  onChangeAccordion,
  guide,
}: ContentMultiStepProps) => {
  return (
    <>
      <Accordion
        type="single"
