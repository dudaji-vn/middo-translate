...
const StarRating = ({ onRate, businessData }: {
    ...
    return (<form action={action} className={cn("max-w-screen-md w-full h-full px-6 m-auto flex flex-col gap-4 items-center py-10")}>
        ...
        <div className='flex items-center md:gap-3 gap-1 py-4'>
