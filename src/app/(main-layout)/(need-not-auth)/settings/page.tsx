 ...
 const {t} = useTranslation();
  return (
    <div className="container-height overflow-auto">
        <div className="mx-auto w-full md:my-8 md:max-w-[500px] md:overflow-hidden md:rounded-xl md:shadow-2">
            <div className="flex flex-col items-center p-8 bg-[#FCFCFC]">
