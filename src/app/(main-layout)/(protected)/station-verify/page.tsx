...
const StationVerify = async ({
  ...
  return (
    <main className="flex h-[80vh] items-center justify-center overflow-y-auto  px-8 md:px-2  ">
      <div className="max-w-screen flex flex-col items-center overflow-y-auto gap-8  leading-8 md:max-w-screen-sm xl:max-w-screen-md">
