...
const MemberItem = ({
  ...
  return (
    <div
      className="flex w-full flex-row items-center justify-between rounded-[12px] bg-primary-100 dark:bg-neutral-900 py-1"
      {...props}
    >
      <div className="flex w-full flex-row items-center justify-start">
        <div className="flex h-auto w-[400px] flex-row items-center justify-start gap-3 break-words rounded-l-[12px] px-3 md:w-[500px] xl:w-[800px]">
          <Typography className="text-neutral-800 dark:text-neutral-50">{email}</Typography>
