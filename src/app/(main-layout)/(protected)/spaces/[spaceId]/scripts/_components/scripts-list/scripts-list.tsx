    ...
    <section className="relative w-full">
      ...
      <div className="w-full overflow-x-auto rounded-md px-10 py-3">
        <DataTable
          ...
          data={scripts}
          tableHeadProps={{
            className: 'bg-white  border-none dark:bg-neutral-900 dark:text-neutral-50',
          }}
          cellProps={{
            className:
          ...
          rowProps={{
            className:
              'bg-white even:bg-primary-100 bg-primary-100 h-12 hover:bg-neutral-50  dark:bg-neutral-900  dark:hover:bg-neutral-800',
          }}
          loading={isLoading}
