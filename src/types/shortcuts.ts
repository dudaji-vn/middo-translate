...
> = {
    ...
    [SCConversation.SWITCH_INPUT_LANGUAGE]: ['ctrl', 'l'],
    ...
    // Call  ===============================================
    [SCCall.MAXIMIZE_MINIMIZE_CALL]: ['ctrl', 'm'],
    [SCCall.ADD_MEMBERS]: ['ctrl', 'a'],
    [SCCall.START_STOP_SCREEN_SHARING]: ['ctrl', 's'],
    [SCCall.TOGGLE_CAMERA]: ['ctrl', 'c'],
    [SCCall.TOGGLE_MICROPHONE]: ['ctrl', 'm'],
    [SCCall.TEMPORARY_MICROPHONE_TOGGLE]: ['ctrl', 'm'],
    [SCCall.TOGGLE_DISCUSSION]: ['ctrl', 'd'],
    [SCCall.SWITCH_TO_GALLERY_VIEW]: ['ctrl', 'g'],
    [SCCall.START_STOP_SCREEN_DOODLE]: ['ctrl', '/'],
    [SCCall.TOGGLE_LIVE_CAPTION]: ['ctrl', 'l'],
};
...
export const SHORTCUT_CONTENTS: Record<SCConversation | SCTranslation | SCCall, string> = {
    ...
    [SCConversation.SWITCH_INPUT_LANGUAGE]: "Switch Input Language",
