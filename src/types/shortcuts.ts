...
> = {
  ...
  [SCConversation.SEARCH_IN_ROOM]: ['ctrl_or_alt', 'r'],
...
> = {
  ...
  [SCConversation.SEARCH_IN_ROOM]: 'Search in Room',
...
export const SHORTCUT_KEYS: Record<string, string> = {
  ...
  [SCTranslation.TRANSLATED_TEXT_TO_SPEECH]:
    'SHORTCUT.TRANSLATED_TEXT_TO_SPEECH',
  ...
  [SCConversation.TOGGLE_CONVERSATION_SETTINGS]:
    'SHORTCUT.TOGGLE_CONVERSATION_SETTINGS',
  ...
  [SCConversation.TURN_ON_OFF_TRANSLATION_PREVIEW]:
    'SHORTCUT.TURN_ON_OFF_TRANSLATION_PREVIEW',
